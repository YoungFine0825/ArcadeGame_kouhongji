...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineVector3Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 6, 7, 6, 3);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetY", _m_SetY);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetY(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    float y = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        UnityEngine.Vector3 __cl_gen_ret = __cl_gen_to_be_invoked.SetY( y );
                        translator.PushUnityEngineVector3(L, __cl_gen_ret);
