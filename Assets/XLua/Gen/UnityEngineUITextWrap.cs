    ...
    public class UnityEngineUITextWrap 
    {
        ...
        static int _m_DOText(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 6&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)&& translator.Assignable<DG.Tweening.ScrambleMode>(L, 5)&& (LuaAPI.lua_isnil(L, 6) || LuaAPI.lua_type(L, 6) == LuaTypes.LUA_TSTRING)) 
                {
                    string endValue = LuaAPI.lua_tostring(L, 2);
                    float duration = (float)LuaAPI.lua_tonumber(L, 3);
                    bool richTextEnabled = LuaAPI.lua_toboolean(L, 4);
                    DG.Tweening.ScrambleMode scrambleMode;translator.Get(L, 5, out scrambleMode);
                    string scrambleChars = LuaAPI.lua_tostring(L, 6);
                    
                        DG.Tweening.Tweener __cl_gen_ret = __cl_gen_to_be_invoked.DOText( endValue, duration, richTextEnabled, scrambleMode, scrambleChars );
                        translator.Push(L, __cl_gen_ret);
                ...
                if(__gen_param_count == 5&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)&& translator.Assignable<DG.Tweening.ScrambleMode>(L, 5)) 
                {
                    string endValue = LuaAPI.lua_tostring(L, 2);
                    float duration = (float)LuaAPI.lua_tonumber(L, 3);
                    bool richTextEnabled = LuaAPI.lua_toboolean(L, 4);
                    DG.Tweening.ScrambleMode scrambleMode;translator.Get(L, 5, out scrambleMode);
                        ...
                        DG.Tweening.Tweener __cl_gen_ret = __cl_gen_to_be_invoked.DOText( endValue, duration, richTextEnabled, scrambleMode );
                        translator.Push(L, __cl_gen_ret);
                ...
                if(__gen_param_count == 4&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    string endValue = LuaAPI.lua_tostring(L, 2);
                    float duration = (float)LuaAPI.lua_tonumber(L, 3);
                    bool richTextEnabled = LuaAPI.lua_toboolean(L, 4);
                    
                        DG.Tweening.Tweener __cl_gen_ret = __cl_gen_to_be_invoked.DOText( endValue, duration, richTextEnabled );
                        translator.Push(L, __cl_gen_ret);
                ...
                if(__gen_param_count == 3&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        DG.Tweening.Tweener __cl_gen_ret = __cl_gen_to_be_invoked.DOText( endValue, duration );
                        translator.Push(L, __cl_gen_ret);
