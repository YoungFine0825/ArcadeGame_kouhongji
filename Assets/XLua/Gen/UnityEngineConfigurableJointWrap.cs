...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineConfigurableJointWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 2, 31, 31);
			
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetTargetRotationEuler", _m_SetTargetRotationEuler);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetTargetRotationEuler(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.SetTargetRotationEuler( x, y, z );
        ...
        static int _m_SetTargetPosition(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.SetTargetPosition( x, y, z );
