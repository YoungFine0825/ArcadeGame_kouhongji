...
#pragma warning restore 1591
        ...
        public bool active; // FALSE when tween is (or should be) despawned - set only by TweenManager
        ...
        public bool playedOnce; // TRUE after the tween was set in a play state at least once, AFTER any delay is elapsed
        public float position; // Time position within a single loop cycle
