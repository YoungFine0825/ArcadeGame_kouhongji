...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEnginePhysics2DWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 50, 29, 29);
        ...
        static int _m_GetContacts_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 4&& translator.Assignable<UnityEngine.Collider2D>(L, 1)&& translator.Assignable<UnityEngine.Collider2D>(L, 2)&& translator.Assignable<UnityEngine.ContactFilter2D>(L, 3)&& translator.Assignable<UnityEngine.ContactPoint2D[]>(L, 4)) 
                {
                    ...
                    UnityEngine.ContactFilter2D contactFilter;translator.Get(L, 3, out contactFilter);
                    UnityEngine.ContactPoint2D[] contacts = (UnityEngine.ContactPoint2D[])translator.GetObject(L, 4, typeof(UnityEngine.ContactPoint2D[]));
                    
                        int __cl_gen_ret = UnityEngine.Physics2D.GetContacts( collider1, collider2, contactFilter, contacts );
                        LuaAPI.xlua_pushinteger(L, __cl_gen_ret);
		    ...
		    try {
                ...
                
                {
                    float step = (float)LuaAPI.lua_tonumber(L, 1);
                        ...
                        bool __cl_gen_ret = UnityEngine.Physics2D.Simulate( step );
        ...
        static int _g_get_autoSimulation(RealStatePtr L)
        {
		    try {
			    ...
			    LuaAPI.lua_pushboolean(L, UnityEngine.Physics2D.autoSimulation);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_autoSimulation(RealStatePtr L)
        {
		    try {
			    ...
			    UnityEngine.Physics2D.autoSimulation = LuaAPI.lua_toboolean(L, 1);
