/********************************************************************
	created:	17:5:2018   
	filename: 	TZObjectList
	author:		jordenwu
	
	purpose:	简化对象列表泛型 用于减少IL 生成
*********************************************************************/
using System;
...
namespace JW.Common
{
    ...
    public partial class JWObjList<T> :
        ObjListBase,
        IEnumerable<T>
    {
        public JWObjList()
        {
            ...
            Log.Assert(
                ...
                "Performance Warning! JWObjList Should Not Contain Value Type!!!!"
                );
#endif
        }

        public JWObjList(IEnumerable<T> collection)
        {
            Context = new List<object>();
    ...
    public partial class JWObjListLinq<T> : JWObjList<T>
    {
        public JWObjListLinq() :
            base()
        {
        }

        public JWObjListLinq(int capacity) :
            base(capacity)
        {
        }
    ...
    public partial class JWObjDictionary<TKey, TValue> : IEnumerable<KeyValuePair<TKey, TValue>>
    {
        protected Dictionary<TKey, object> Context = null;

        public JWObjDictionary()
        {
            Context = new Dictionary<TKey, object>();
        }

        public JWObjDictionary(int capacity)
        {
            Context = new Dictionary<TKey, object>(capacity);
        }

        public JWObjDictionary(IEqualityComparer<TKey> comparer)
        {
            Context = new Dictionary<TKey, object>(comparer);
        }

        public JWObjDictionary(int capacity, IEqualityComparer<TKey> comparer)
        {
    ...
    */
    public partial class JWObjObjDictionary<TKey, TValue> : IEnumerable<KeyValuePair<TKey, TValue>>
    {
        protected Dictionary<object, object> Context = null;

        public JWObjObjDictionary()
        {
        ...
        public JWObjObjDictionary(int capacity)
        {
