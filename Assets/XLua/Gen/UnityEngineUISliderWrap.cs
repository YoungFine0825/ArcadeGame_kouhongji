...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineUISliderWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "DOValue", _m_DOValue);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DOValue(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool snapping = LuaAPI.lua_toboolean(L, 4);
                        ...
                        DG.Tweening.Tweener __cl_gen_ret = __cl_gen_to_be_invoked.DOValue( endValue, duration, snapping );
                        translator.Push(L, __cl_gen_ret);
                ...
                if(__gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        DG.Tweening.Tweener __cl_gen_ret = __cl_gen_to_be_invoked.DOValue( endValue, duration );
                        translator.Push(L, __cl_gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.UI.Slider.DOValue!");
