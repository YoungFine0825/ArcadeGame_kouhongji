...
namespace DG.Tweening.Plugins.Options
{
    ...
    public struct PathOptions : IPlugOptions
    {
        ...
        public Quaternion startupRot; // Used to reset orientation when rewinding
        public float startupZRot; // Used to store Z value in case of lock Z, in order to rotate things differently
