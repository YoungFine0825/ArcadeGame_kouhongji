...
public class UltimateRopeEditor : Editor
{
    ...
    SerializedProperty PropCurrentExtension;
...
//  SerializedProperty PropAutoRegenerate;
    ...
    void OnEnable()
    {
        PropCurrentExtension             = serializedObject.FindProperty("m_fCurrentExtension");
...
//      PropAutoRegenerate               = serializedObject.FindProperty("AutoRegenerate");
    ...
    public override void OnInspectorGUI()
    {
        ...
        //jordenwu
        PropCurrentExtension.floatValue = EditorGUILayout.FloatField(new GUIContent("CurrentExtension", "Jordenwu Add"), PropCurrentExtension.floatValue);
