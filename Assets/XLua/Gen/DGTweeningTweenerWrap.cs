...
namespace XLua.CSObjectWrap
{
    ...
    public class DGTweeningTweenerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 27, 2, 2);
			...
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "hasManuallySetStartValue", _g_get_hasManuallySetStartValue);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "isFromAllowed", _g_get_isFromAllowed);
            
			Utils.RegisterFunc(L, Utils.SETTER_IDX, "hasManuallySetStartValue", _s_set_hasManuallySetStartValue);
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "isFromAllowed", _s_set_isFromAllowed);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_hasManuallySetStartValue(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                DG.Tweening.Tweener __cl_gen_to_be_invoked = (DG.Tweening.Tweener)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, __cl_gen_to_be_invoked.hasManuallySetStartValue);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_isFromAllowed(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                DG.Tweening.Tweener __cl_gen_to_be_invoked = (DG.Tweening.Tweener)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, __cl_gen_to_be_invoked.isFromAllowed);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_hasManuallySetStartValue(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                DG.Tweening.Tweener __cl_gen_to_be_invoked = (DG.Tweening.Tweener)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.hasManuallySetStartValue = LuaAPI.lua_toboolean(L, 2);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_isFromAllowed(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                DG.Tweening.Tweener __cl_gen_to_be_invoked = (DG.Tweening.Tweener)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.isFromAllowed = LuaAPI.lua_toboolean(L, 2);
