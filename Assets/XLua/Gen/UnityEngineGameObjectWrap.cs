...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineGameObjectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 18, 8, 3);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ExtSetLayer", _m_ExtSetLayer);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ExtSetLayerRecursively", _m_ExtSetLayerRecursively);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ExtAddChild", _m_ExtAddChild);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ExtSetUIActive", _m_ExtSetUIActive);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ExtGetUIActive", _m_ExtGetUIActive);
        ...
        static int _m_ExtSetActive(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.ExtSetActive( value );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ExtSetLayer(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.ExtSetLayer( layer );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ExtSetLayerRecursively(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.ExtSetLayerRecursively( layer );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ExtAddChild(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 1) 
                {
                        ...
                        UnityEngine.GameObject __cl_gen_ret = __cl_gen_to_be_invoked.ExtAddChild(  );
                        translator.Push(L, __cl_gen_ret);
                ...
                if(__gen_param_count == 2&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    string name = LuaAPI.lua_tostring(L, 2);
                        ...
                        UnityEngine.GameObject __cl_gen_ret = __cl_gen_to_be_invoked.ExtAddChild( name );
                        translator.Push(L, __cl_gen_ret);
                ...
                {
                    UnityEngine.Object prefab = (UnityEngine.Object)translator.GetObject(L, 2, typeof(UnityEngine.Object));
                    
                        UnityEngine.GameObject __cl_gen_ret = __cl_gen_to_be_invoked.ExtAddChild( prefab );
                        translator.Push(L, __cl_gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.GameObject.ExtAddChild!");
            
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ExtSetUIActive(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.ExtSetUIActive( active );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ExtGetUIActive(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        bool __cl_gen_ret = __cl_gen_to_be_invoked.ExtGetUIActive(  );
                        LuaAPI.lua_pushboolean(L, __cl_gen_ret);
