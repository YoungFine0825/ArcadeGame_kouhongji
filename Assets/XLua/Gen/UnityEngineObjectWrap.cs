...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineObjectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 1, 9, 2, 2);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ExtDestroy", _m_ExtDestroy);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ExtDestroyImmediate", _m_ExtDestroyImmediate);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ExtInstantiate", _m_ExtInstantiate);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ExtDontDestroyOnLoad", _m_ExtDontDestroyOnLoad);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ExtDestroy(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 1) 
                {
                    ...
                    __cl_gen_to_be_invoked.ExtDestroy(  );
                ...
                if(__gen_param_count == 2&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)) 
                {
                    ...
                    __cl_gen_to_be_invoked.ExtDestroy( delayTime );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Object.ExtDestroy!");
            
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ExtDestroyImmediate(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.ExtDestroyImmediate(  );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ExtInstantiate(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 1) 
                {
                        ...
                        UnityEngine.Object __cl_gen_ret = __cl_gen_to_be_invoked.ExtInstantiate(  );
                        translator.Push(L, __cl_gen_ret);
                ...
                if(__gen_param_count == 3&& translator.Assignable<UnityEngine.Vector3>(L, 2)&& translator.Assignable<UnityEngine.Quaternion>(L, 3)) 
                {
                    UnityEngine.Vector3 position;translator.Get(L, 2, out position);
                    UnityEngine.Quaternion rotation;translator.Get(L, 3, out rotation);
                    
                        UnityEngine.Object __cl_gen_ret = __cl_gen_to_be_invoked.ExtInstantiate( position, rotation );
                        translator.Push(L, __cl_gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Object.ExtInstantiate!");
            
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ExtDontDestroyOnLoad(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.ExtDontDestroyOnLoad(  );
