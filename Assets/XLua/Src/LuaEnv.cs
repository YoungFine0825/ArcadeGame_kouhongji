...
namespace XLua
{
    ...
    public class LuaEnv : IDisposable
    {
        ...
        //异常处理
        public System.Action<string> ExceptionHandler=null;
        ...
        public LuaEnv()
        {
            ...
            lock(luaEnvLock)
            {
                ...
                //jordenwu
                //AddBuildin("pbc", StaticLuaCallbacks.LoadProtobufC);
                AddBuildin("pb", StaticLuaCallbacks.LoadProtobufCC);
