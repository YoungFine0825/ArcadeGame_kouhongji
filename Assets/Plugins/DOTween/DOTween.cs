...
namespace DG.Tweening
{
    ...
    public class DOTween
    {
        ...
        public static DOTweenComponent instance; // Assigned/removed by DOTweenComponent.Create/DestroyInstance
        ...
        public static readonly List<TweenCallback> GizmosDelegates = new List<TweenCallback>(); // Can be used by other classes to call public gizmo draw methods
        public static bool initialized; // Can be set to false by DOTweenComponent OnDestroy
        ...
        // Used publicly to complete a tween and return only the number of killed tweens instead than just the completed ones
