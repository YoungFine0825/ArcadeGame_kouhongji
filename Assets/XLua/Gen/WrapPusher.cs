...
namespace XLua
{
    public partial class ObjectTranslator
    {
        ...
        class IniterAdderUnityEngineVector2
        {
			...
			static void Init(LuaEnv luaenv, ObjectTranslator translator)
			{
				...
				translator.RegisterPushAndGetAndUpdate<UnityEngine.EventType>(translator.PushUnityEngineEventType, translator.Get, translator.UpdateUnityEngineEventType);
				translator.RegisterPushAndGetAndUpdate<JW.Framework.IFS.IFSState>(translator.PushJWFrameworkIFSIFSState, translator.Get, translator.UpdateJWFrameworkIFSIFSState);
        ...
        int UnityEngineEventType_TypeID = -1;
		int UnityEngineEventType_EnumRef = -1;
        
        public void PushUnityEngineEventType(RealStatePtr L, UnityEngine.EventType val)
        {
            if (UnityEngineEventType_TypeID == -1)
            {
			    bool is_first;
                UnityEngineEventType_TypeID = getTypeId(L, typeof(UnityEngine.EventType), out is_first);
				
				if (UnityEngineEventType_EnumRef == -1)
				{
				    Utils.LoadCSTable(L, typeof(UnityEngine.EventType));
				    UnityEngineEventType_EnumRef = LuaAPI.luaL_ref(L, LuaIndexes.LUA_REGISTRYINDEX);
				}
				
            }
			
			if (LuaAPI.xlua_tryget_cachedud(L, (int)val, UnityEngineEventType_EnumRef) == 1)
            {
			    return;
			}
			
            IntPtr buff = LuaAPI.xlua_pushstruct(L, 4, UnityEngineEventType_TypeID);
            if (!CopyByValue.Pack(buff, 0, (int)val))
            {
                throw new Exception("pack fail fail for UnityEngine.EventType ,value="+val);
            }
			
			LuaAPI.lua_getref(L, UnityEngineEventType_EnumRef);
			LuaAPI.lua_pushvalue(L, -2);
			LuaAPI.xlua_rawseti(L, -2, (int)val);
			LuaAPI.lua_pop(L, 1);
        ...
        public void Get(RealStatePtr L, int index, out UnityEngine.EventType val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != UnityEngineEventType_TypeID)
				{
				    throw new Exception("invalid userdata for UnityEngine.EventType");
				}
                ...
                if (!CopyByValue.UnPack(buff, 0, out e))
                {
                    throw new Exception("unpack fail for UnityEngine.EventType");
                }
				val = (UnityEngine.EventType)e;
                
            }
            else
            {
                val = (UnityEngine.EventType)objectCasters.GetCaster(typeof(UnityEngine.EventType))(L, index, null);
            }
        }
		
        public void UpdateUnityEngineEventType(RealStatePtr L, int index, UnityEngine.EventType val)
        {
            ...
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
                ...
                if (!CopyByValue.Pack(buff, 0,  (int)val))
                {
                    throw new Exception("pack fail for UnityEngine.EventType ,value="+val);
                }
            }
        ...
        int JWFrameworkIFSIFSState_TypeID = -1;
		int JWFrameworkIFSIFSState_EnumRef = -1;
        
        public void PushJWFrameworkIFSIFSState(RealStatePtr L, JW.Framework.IFS.IFSState val)
        {
            if (JWFrameworkIFSIFSState_TypeID == -1)
            {
			    bool is_first;
                JWFrameworkIFSIFSState_TypeID = getTypeId(L, typeof(JW.Framework.IFS.IFSState), out is_first);
				
				if (JWFrameworkIFSIFSState_EnumRef == -1)
				{
				    Utils.LoadCSTable(L, typeof(JW.Framework.IFS.IFSState));
				    JWFrameworkIFSIFSState_EnumRef = LuaAPI.luaL_ref(L, LuaIndexes.LUA_REGISTRYINDEX);
				}
				
            }
			
			if (LuaAPI.xlua_tryget_cachedud(L, (int)val, JWFrameworkIFSIFSState_EnumRef) == 1)
            {
			    return;
			}
			
            IntPtr buff = LuaAPI.xlua_pushstruct(L, 4, JWFrameworkIFSIFSState_TypeID);
            if (!CopyByValue.Pack(buff, 0, (int)val))
            {
                throw new Exception("pack fail fail for JW.Framework.IFS.IFSState ,value="+val);
            }
			
			LuaAPI.lua_getref(L, JWFrameworkIFSIFSState_EnumRef);
			LuaAPI.lua_pushvalue(L, -2);
			LuaAPI.xlua_rawseti(L, -2, (int)val);
			LuaAPI.lua_pop(L, 1);
        ...
        public void Get(RealStatePtr L, int index, out JW.Framework.IFS.IFSState val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != JWFrameworkIFSIFSState_TypeID)
				{
				    throw new Exception("invalid userdata for JW.Framework.IFS.IFSState");
				}
                ...
                if (!CopyByValue.UnPack(buff, 0, out e))
                {
                    throw new Exception("unpack fail for JW.Framework.IFS.IFSState");
                }
				val = (JW.Framework.IFS.IFSState)e;
                
            }
            else
            {
                val = (JW.Framework.IFS.IFSState)objectCasters.GetCaster(typeof(JW.Framework.IFS.IFSState))(L, index, null);
            }
        }
		
        public void UpdateJWFrameworkIFSIFSState(RealStatePtr L, int index, JW.Framework.IFS.IFSState val)
        {
            ...
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
                ...
                if (!CopyByValue.Pack(buff, 0,  (int)val))
                {
                    throw new Exception("pack fail for JW.Framework.IFS.IFSState ,value="+val);
                }
            }
	...
	public partial class StaticLuaCallbacks
    {
	    internal static bool __tryArrayGet(Type type, RealStatePtr L, ObjectTranslator translator, object obj, int index)
		{
			...
			else if (type == typeof(JW.Framework.IFS.IFSState[]))
			{
			    JW.Framework.IFS.IFSState[] array = obj as JW.Framework.IFS.IFSState[];
				translator.PushJWFrameworkIFSIFSState(L, array[index]);
				return true;
			}
            return false;
		}
