		    ...
		    try {
                ...
                if(__gen_param_count == 4&& translator.Assignable<UnityEngine.Vector2>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool snapping = LuaAPI.lua_toboolean(L, 4);
                        ...
                        DG.Tweening.Tweener __cl_gen_ret = __cl_gen_to_be_invoked.DONormalizedPos( endValue, duration, snapping );
                ...
                if(__gen_param_count == 3&& translator.Assignable<UnityEngine.Vector2>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        DG.Tweening.Tweener __cl_gen_ret = __cl_gen_to_be_invoked.DONormalizedPos( endValue, duration );
                        translator.Push(L, __cl_gen_ret);
		    ...
		    try {
                ...
                if(__gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool snapping = LuaAPI.lua_toboolean(L, 4);
                        ...
                        DG.Tweening.Tweener __cl_gen_ret = __cl_gen_to_be_invoked.DOHorizontalNormalizedPos( endValue, duration, snapping );
                        translator.Push(L, __cl_gen_ret);
                ...
                if(__gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        DG.Tweening.Tweener __cl_gen_ret = __cl_gen_to_be_invoked.DOHorizontalNormalizedPos( endValue, duration );
                        translator.Push(L, __cl_gen_ret);
		    ...
		    try {
                ...
                if(__gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool snapping = LuaAPI.lua_toboolean(L, 4);
                        ...
                        DG.Tweening.Tweener __cl_gen_ret = __cl_gen_to_be_invoked.DOVerticalNormalizedPos( endValue, duration, snapping );
                        translator.Push(L, __cl_gen_ret);
                ...
                if(__gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        DG.Tweening.Tweener __cl_gen_ret = __cl_gen_to_be_invoked.DOVerticalNormalizedPos( endValue, duration );
                        translator.Push(L, __cl_gen_ret);
