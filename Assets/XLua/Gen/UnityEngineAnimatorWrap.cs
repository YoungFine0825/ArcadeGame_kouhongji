    ...
    public class UnityEngineAnimatorWrap 
    {
        ...
        static int _m_GetBehaviours(RealStatePtr L)
        {
		    try {
                ...
                {
                    int fullPathHash = LuaAPI.xlua_tointeger(L, 2);
                    int layerIndex = LuaAPI.xlua_tointeger(L, 3);
                    
                        UnityEngine.StateMachineBehaviour[] __cl_gen_ret = __cl_gen_to_be_invoked.GetBehaviours( fullPathHash, layerIndex );
                        translator.Push(L, __cl_gen_ret);
        ...
        static int _m_CrossFadeInFixedTime(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    int stateHashName = LuaAPI.xlua_tointeger(L, 2);
                    float fixedTransitionDuration = (float)LuaAPI.lua_tonumber(L, 3);
                    
                    __cl_gen_to_be_invoked.CrossFadeInFixedTime( stateHashName, fixedTransitionDuration );
                ...
                if(__gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    __cl_gen_to_be_invoked.CrossFadeInFixedTime( stateHashName, fixedTransitionDuration, layer );
                ...
                if(__gen_param_count == 5&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)) 
                {
                    ...
                    float fixedTransitionDuration = (float)LuaAPI.lua_tonumber(L, 3);
                    int layer = LuaAPI.xlua_tointeger(L, 4);
                    float fixedTimeOffset = (float)LuaAPI.lua_tonumber(L, 5);
                    
                    __cl_gen_to_be_invoked.CrossFadeInFixedTime( stateHashName, fixedTransitionDuration, layer, fixedTimeOffset );
                ...
                if(__gen_param_count == 6&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 6)) 
                {
                    ...
                    int layer = LuaAPI.xlua_tointeger(L, 4);
                    float fixedTimeOffset = (float)LuaAPI.lua_tonumber(L, 5);
                    float normalizedTransitionTime = (float)LuaAPI.lua_tonumber(L, 6);
                    
                    __cl_gen_to_be_invoked.CrossFadeInFixedTime( stateHashName, fixedTransitionDuration, layer, fixedTimeOffset, normalizedTransitionTime );
                ...
                if(__gen_param_count == 3&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    __cl_gen_to_be_invoked.CrossFadeInFixedTime( stateName, fixedTransitionDuration );
                ...
                if(__gen_param_count == 4&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    __cl_gen_to_be_invoked.CrossFadeInFixedTime( stateName, fixedTransitionDuration, layer );
                ...
                if(__gen_param_count == 5&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)) 
                {
                    ...
                    __cl_gen_to_be_invoked.CrossFadeInFixedTime( stateName, fixedTransitionDuration, layer, fixedTimeOffset );
                    
                    
                    
                    return 0;
                }
                if(__gen_param_count == 6&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 6)) 
                {
                    string stateName = LuaAPI.lua_tostring(L, 2);
                    float fixedTransitionDuration = (float)LuaAPI.lua_tonumber(L, 3);
                    int layer = LuaAPI.xlua_tointeger(L, 4);
                    ...
                    __cl_gen_to_be_invoked.CrossFadeInFixedTime( stateName, fixedTransitionDuration, layer, fixedTimeOffset, normalizedTransitionTime );
        ...
        static int _m_CrossFade(RealStatePtr L)
        {
		    try {
                ...
                {
                    int stateHashName = LuaAPI.xlua_tointeger(L, 2);
                    float normalizedTransitionDuration = (float)LuaAPI.lua_tonumber(L, 3);
                    
                    __cl_gen_to_be_invoked.CrossFade( stateHashName, normalizedTransitionDuration );
                ...
                if(__gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    __cl_gen_to_be_invoked.CrossFade( stateHashName, normalizedTransitionDuration, layer );
                ...
                if(__gen_param_count == 5&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)) 
                {
                    ...
                    float normalizedTransitionDuration = (float)LuaAPI.lua_tonumber(L, 3);
                    int layer = LuaAPI.xlua_tointeger(L, 4);
                    float normalizedTimeOffset = (float)LuaAPI.lua_tonumber(L, 5);
                    
                    __cl_gen_to_be_invoked.CrossFade( stateHashName, normalizedTransitionDuration, layer, normalizedTimeOffset );
                ...
                if(__gen_param_count == 6&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 6)) 
                {
                    ...
                    __cl_gen_to_be_invoked.CrossFade( stateHashName, normalizedTransitionDuration, layer, normalizedTimeOffset, normalizedTransitionTime );
                ...
                if(__gen_param_count == 3&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    __cl_gen_to_be_invoked.CrossFade( stateName, normalizedTransitionDuration );
                ...
                if(__gen_param_count == 4&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    __cl_gen_to_be_invoked.CrossFade( stateName, normalizedTransitionDuration, layer );
                ...
                if(__gen_param_count == 5&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)) 
                {
                    ...
                    __cl_gen_to_be_invoked.CrossFade( stateName, normalizedTransitionDuration, layer, normalizedTimeOffset );
                ...
                if(__gen_param_count == 6&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 6)) 
                {
                    ...
                    __cl_gen_to_be_invoked.CrossFade( stateName, normalizedTransitionDuration, layer, normalizedTimeOffset, normalizedTransitionTime );
