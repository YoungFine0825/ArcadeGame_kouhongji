...
namespace DG.Tweening
{
    ...
    public abstract class Tweener : Tween
    {
        ...
        public bool isFromAllowed = true; // if FALSE from tweens won't be allowed. Reset by TweenerCore
        ...
        public static bool Setup<T1, T2, TPlugOptions>(
        ...
        // CALLED BY TweenerCore
        public static Tweener DoChangeStartValue<T1, T2, TPlugOptions>(
        ...
        // CALLED BY TweenerCore
        public static Tweener DoChangeEndValue<T1, T2, TPlugOptions>(
        ...
        public static Tweener DoChangeValues<T1, T2, TPlugOptions>(
