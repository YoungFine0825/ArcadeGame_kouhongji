...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineEventWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 5, 22, 17);
		    ...
		    try {
                ...
                
                {
                    int controlID = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        translator.PushUnityEngineEventType(L, __cl_gen_ret);
        ...
        static int _g_get_rawType(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Event __cl_gen_to_be_invoked = (UnityEngine.Event)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineEventType(L, __cl_gen_to_be_invoked.rawType);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_type(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Event __cl_gen_to_be_invoked = (UnityEngine.Event)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineEventType(L, __cl_gen_to_be_invoked.type);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
