    ...
    public class UnityEngineEventsUnityEvent_1_UnityEngineEventSystemsPointerEventData_Wrap 
    {
        ...
        static int _m_AddListener(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Events.UnityEvent<UnityEngine.EventSystems.PointerEventData> __cl_gen_to_be_invoked = (UnityEngine.Events.UnityEvent<UnityEngine.EventSystems.PointerEventData>)translator.FastGetCSObj(L, 1);
            
            
                
                {
                    UnityEngine.Events.UnityAction<UnityEngine.EventSystems.PointerEventData> call = translator.GetDelegate<UnityEngine.Events.UnityAction<UnityEngine.EventSystems.PointerEventData>>(L, 2);
        ...
        static int _m_Invoke(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.EventSystems.PointerEventData arg0 = (UnityEngine.EventSystems.PointerEventData)translator.GetObject(L, 2, typeof(UnityEngine.EventSystems.PointerEventData));
