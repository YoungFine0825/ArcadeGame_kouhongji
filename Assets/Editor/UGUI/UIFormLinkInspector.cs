...
[CustomEditor(typeof(UIFormLink))]
public class UIFormLinkInspector : UnityEditor.Editor
{
    //界面使用
    ...
    /// </summary>
    /// <param name="link"></param>
    protected static void CopyElementDeclareLua(UIFormLink link)
    {
        if (link == null)
        {
            return;
    ...
    /// </summary>
    /// <param name="link"></param>
    protected static void CopyElementInitializeLua(UIFormLink link)
    {
        if (link == null)
        {
            return;
    ...
    protected static void CopyElementUnIninitialize(UIFormLink link)
    {
        if (link == null)
        {
            return;
